                ...
                <div className='flex w-full min-w-72 grow flex-col items-stretch justify-center gap-1 p-4 @xl:px-4'>
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex items-center'>
                            <Star size={16} className=' text-yellow-400 mr-1 mb-1'/>
                    ...
                    <div className='flex items-end gap-3 justify-between'>
                        <div className='flex flex-col gap-1'>
                            ...
                            <p className='text-blue-600 text-base font-bold leading-normal'>
                                ${price}/night
                            </p>
                        </div>
                    </div>
                    <Link to={`/venues/${id}`}
                          className='bg-brand-primary text-white border rounded-lg text-center p-2 hover:underline text-sm font-medium'>
                        View details
                    </Link>
                </div>
            </div>
