                ...
                <div className='flex w-full min-w-72 grow flex-col items-stretch justify-center gap-1 p-4 @xl:px-4'>
                    ...
                    <div className='flex items-end justify-between gap-3'>
                        <div className='flex flex-col gap-1'>
                            <p className='opacity-80 text-base font-normal leading-normal'>
                                {location.city || 'Koh Samui'}, {location.country || 'Thailand'}
                            </p>
                            <p className='pb-3 text-base font-bold leading-normal text-brand-primary'>
                                ${price}/night
                            </p>
                        </div>
                    </div>
                    ...
                    <Link to={`/venues/${id}`}
                          className='rounded-lg border p-2 text-center font-medium text-white bg-brand-primary hover:bg-brand-hover transition-colors duration-200'>
                        View details
                    </Link>
                </div>
            </div>
