...
export function Footer() {
    ...
    return (
        <>
            <footer className={isProfilePage ? 'bg-white' : 'bg-gray-100'}>
                <div className='mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8'>
                    <div className='flex justify-center text-brand-primary text-3xl font-logo font-semibold'>
                        Holidaze
                    </div>

                    <p className='mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500'>
                        Discover and book unique homes and vacation rentals worldwide.<br/>
